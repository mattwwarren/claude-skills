---
name: auto-dev
description: Automated Linear→plan→implement→review→ship pipeline with scope-based approval automation. Use when given a Linear ticket and told to take it through full development. Triggers on "auto-dev", "ship this ticket", "/auto-dev".
---
