---
name: review
description: Code review using parallel specialized agents (architecture, performance, test, deployment, security, data-safety, etc.). Only actionable findings surface. Use when reviewing changes on a branch or PR. Triggers on "review this", "code review", "/review".
---
