...
description: Pull next queue item, spawn agent teams, review, and complete. Use as the execution engine for queued work items in the cw CLI multi-session orchestrator. Triggers on "pull next", "execute queue item", "/pull-and-execute".
---
