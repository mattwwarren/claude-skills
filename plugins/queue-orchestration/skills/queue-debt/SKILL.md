---
name: queue-debt
description: Queue a tech debt item with optional priority. Use when capturing tech debt work for a dedicated debt session. Triggers on "queue debt", "tech debt ticket", "/queue-debt".
---
