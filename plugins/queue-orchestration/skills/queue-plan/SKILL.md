---
name: queue-plan
description: Queue an approved plan for implementation via the cw task queue. Use when a plan has been approved and should be picked up by a later /pull-and-execute session. Triggers on "queue plan", "/queue-plan".
---
