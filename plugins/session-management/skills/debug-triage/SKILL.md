---
name: debug-triage
description: Structured debugging with issue tracking, hypothesis confirmation, and pipeline handoff. Use when debugging a bug with multiple suspects or when a fire drill needs organizing. Tracks each issue with enriched context, flows output into Linear and /auto-dev. Triggers on "debug", "triage issue", "investigate bug", "fire drill".
---
