---
name: handoff
description: Generate structured handoff documents for abnormal session endings. Use when context is approaching exhaustion (80%+), debugging has gone 2+ levels deep without resolution, or task scope has expanded beyond the original intent. Triggers on "handoff", "save state", "fork debug session", low-context warnings.
---
...
Use the templates in the `templates/` directory next to this SKILL.md:
