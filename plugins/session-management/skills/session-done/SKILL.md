---
name: session-done
description: Wrap up the current work session by generating a handoff document and signaling completion to the cw orchestrator. Use when work is finished or at a clean stopping point. Triggers on "session done", "wrap up", "done for the day", "/session-done".
---
