---
name: plan-executor
description: Execute an approved markdown plan phase-by-phase, spawning parallel sub-agents for independent tasks. Use when given an H2-phased plan with checkbox tasks and told to run it. Triggers on "execute plan", "run the plan", "/plan-executor".
---
